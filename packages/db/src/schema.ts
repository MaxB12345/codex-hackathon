...
export const phaseTwoSchema: TableDefinition[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'setup_config_json', type: 'text', default: "'{}'" },
      { name: 'created_at', type: 'text', default: 'CURRENT_TIMESTAMP' },
    ],
    indexes: [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'structured_json', type: 'text', default: "'{}'" },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'repro_steps_json', type: 'text', default: "'[]'" },
      { name: 'environment_json', type: 'text', default: "'{}'" },
      { name: 'status', type: 'text' },
      { name: 'severity', type: 'integer' },
      { name: 'priority_score', type: 'real', default: '0' },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'artifact_json', type: 'text', default: "'{}'" },
      { name: 'created_at', type: 'text', default: 'CURRENT_TIMESTAMP' },
    ],
  },
  {
    ...
    columns: [
      ...
      { name: 'suspected_files_json', type: 'text', default: "'[]'" },
      { name: 'created_at', type: 'text', default: 'CURRENT_TIMESTAMP' },
    ],
  },
  {
    ...
    columns: [
      ...
      { name: 'plan_json', type: 'text', default: "'{}'" },
      { name: 'changed_files_json', type: 'text', default: "'[]'" },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'status', type: 'text' },
      { name: 'input_json', type: 'text', default: "'{}'" },
      { name: 'output_json', type: 'text', default: "'{}'" },
      { name: 'created_at', type: 'text', default: 'CURRENT_TIMESTAMP' },
    ],
  },
  {
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'ticket_id', type: 'text', references: 'tickets(id)', nullable: true },
      { name: 'status', type: 'text' },
      { name: 'command_history_json', type: 'text', default: "'[]'" },
